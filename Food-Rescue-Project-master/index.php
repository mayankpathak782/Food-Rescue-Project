...
<div style="margin-left: 150px;text-align: center;margin-top: 30px;">
  ...
  <a href="cs.html">Exchange Food</a>
   ...
   <div>
     <marquee behavior="scroll" direction="left" scrollamount="20" Onmouseover="stop()" Onmouseout="start()"><h4 style="font-size:20px;color: red;"><b>*Throwing away food is like stealing from the table of those who are poor and hungry. ... Donate food near me Toll Free  +91 9621918975 India</b></h4></marquee>
         ...
         <a href="#">Food Rescue</a>.
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <ul class="social-icons">
              ...
              <li><a class="twitter" href="https://twitter.com/ma_yankp?t=qq4uhXtBHHDhvcDGC39xUw&s=09"><i class="fa fa-twitter"></i></a></li>
              <li><a class="github" href="https://github.com/mayankpathak782"><i class="fa fa-github"></i></a></li>
              <li><a class="linkedin" href="https://www.linkedin.com/in/mayank-pathak-25a007181"><i class="fa fa-linkedin"></i></a></li>   
            </ul>
          </div>
        </div>
      </div>
